    ...
    public static async Task SeedAsync(ApplicationDBContext context, CancellationToken cancellationToken)
    {
        ...
        var parcels = new List<ParcelDeliveryOrder>
        {
            new()
            {
                ...
                Items =
                    new List<ParcelDeliveryOrderItem>
                    {
                        new()
                        {
                            ProductId = 1,
                            ProductName = "Má phanh trước Honda Vision",
                            Sku = "HD-MP-VIS-01",
                            ShelfLocation = "A-12",
                            Quantity = 2,
                            IsPicked = false,
                        ...
                        {
                            ProductId = 2,
                            ProductName = "Dầu nhớt Castrol Power1 1L",
                            Sku = "CAS-POWER1-1L",
                            ShelfLocation = "B-03",
                            Quantity = 1,
                            IsPicked = false,
            ...
            new()
            {
                ...
                Items =
                    new List<ParcelDeliveryOrderItem>
                    {
                        ...
                        {
                            ProductId = 3,
                            ProductName = "Nhông xích xe máy Exciter 150 D.I.D",
                            Sku = "DID-NX-EX150",
                            ShelfLocation = "C-15",
                            Quantity = 1,
                            IsPicked = true,
            ...
            new()
            {
                ...
                Items =
                    new List<ParcelDeliveryOrderItem>
                    {
                        ...
                        {
                            ProductId = 4,
                            ProductName = "Bóng đèn pha LED Philips H4",
                            Sku = "PHI-LED-H4",
                            ShelfLocation = "D-20",
                            Quantity = 2,
                            IsPicked = false,
            ...
            new()
            {
                ...
                Items =
                    new List<ParcelDeliveryOrderItem>
                    {
                        ...
                        {
                            ProductId = 5,
                            ProductName = "Lốp xe không săm Michelin City Grip 2",
                            Sku = "MIC-CG2-100-90",
                            ShelfLocation = "E-05",
                            Quantity = 1,
                            IsPicked = true,
            ...
            new()
            {
                ...
                Items =
                    new List<ParcelDeliveryOrderItem>
                    {
                        ...
                        {
                            ProductId = 6,
                            ProductName = "Kính chiếu hậu xe máy kiểng Rizoma",
                            Sku = "RIZ-CH-K1",
                            ShelfLocation = "F-02",
                            Quantity = 2,
                            IsPicked = true,
            ...
            new()
            {
                ...
                Items =
                    new List<ParcelDeliveryOrderItem>
                    {
                        ...
                        {
                            ProductId = 7,
                            ProductName = "Ắc quy xe máy Globe 12V 5Ah",
                            Sku = "GLO-AQ-5AH",
                            ShelfLocation = "G-08",
                            Quantity = 1,
                            IsPicked = true,
            ...
            new()
            {
                ...
                Items =
                    new List<ParcelDeliveryOrderItem>
                    {
                        ...
                        {
                            ProductId = 8,
                            ProductName = "Dây curoa Bando Honda SH150",
                            Sku = "BAN-CR-SH150",
                            ShelfLocation = "H-01",
                            Quantity = 1,
                            IsPicked = true,
            ...
            new()
            {
                ...
                Items =
                    new List<ParcelDeliveryOrderItem>
                    {
                        ...
                        {
                            ProductId = 9,
                            ProductName = "Phuộc sau xe máy Ohlins bình dầu",
                            Sku = "OHL-PH-BD01",
                            ShelfLocation = "I-10",
                            Quantity = 2,
                            IsPicked = true,
            ...
            new()
            {
                ...
                Items =
                    new List<ParcelDeliveryOrderItem>
                    {
                        ...
                        {
                            ProductId = 10,
                            ProductName = "Lọc gió xe máy K&N chính hãng",
                            Sku = "KN-LG-01",
                            ShelfLocation = "J-04",
                            Quantity = 1,
                            IsPicked = true,
            ...
            new()
            {
                ...
                Items =
                    new List<ParcelDeliveryOrderItem>
                    {
                        ...
                        {
                            ProductId = 11,
                            ProductName = "Ốp pô carbon xe máy Click/Vario",
                            Sku = "CAR-OP-CL01",
                            ShelfLocation = "K-02",
                            Quantity = 1,
                            IsPicked = true,
