...
{
    public static IReadOnlyList<ContractTemplate> CreateSeedTemplates(DateTimeOffset currentDate) => [new ContractTemplate
    {
        ...
        Content =
            """
                      ...
                      """,
        DynamicFields =
            """["ContractNumber","CustomerName","CustomerIdCard","CustomerAddress","ShowroomName","ShowroomAddress","VehicleName","VehicleColor","ChassisNumber","EngineNumber","VehiclePrice","VehiclePriceInWords","DepositAmount","RemainingAmount","PaymentMethod","DeliveryDate","DeliveryLocation","WarrantyMonths"]""",
        IsActive = true,
    ...
    }, new ContractTemplate
    {
        ...
        Content =
            """
                      ...
                      """,
        DynamicFields =
            """["contractNumber","customerName","customerCccd","customerAddress","financialPartner","loanAmount","termMonths"]""",
        IsActive = true,
        Status = ContractTemplateStatus.Active,
        IsUsed = false,
        CreatedAt = currentDate,
    ...
    }, new ContractTemplate
    {
        ...
        Content =
            """
                      ...
                      """,
        DynamicFields =
            """["contractNumber","supplierName","taxCode","supplierAddress","contractValue","paymentTerms"]""",
        IsActive = true,
        Status = ContractTemplateStatus.Active,
        IsUsed = false,
        CreatedAt = currentDate,
