...
public class ApplicationDBContext : IdentityDbContext<ApplicationUser, ApplicationRole, Guid>
{
 ...
 protected override void OnModelCreating(ModelBuilder modelBuilder)
 {
  ...
  modelBuilder.Entity<Domain.Entities.Logistics.Shipment>().Property(e => e.CodAmount).HasPrecision(18, 2);
  modelBuilder.Entity<Domain.Entities.Logistics.Shipment>().Property(e => e.ShippingCost).HasPrecision(18, 2);
  ...
  .OnDelete(DeleteBehavior.Cascade);
  modelBuilder.Entity<WarrantyClaim>()
  .Property(e => e.TotalPartsCost).HasPrecision(18, 2);
  modelBuilder.Entity<WarrantyClaim>()
  .Property(e => e.TotalLaborCost).HasPrecision(18, 2);
  modelBuilder.Entity<WarrantyClaimPart>()
  ...
  .OnDelete(DeleteBehavior.SetNull);
  modelBuilder.Entity<MaintenanceHistory>()
  .Property(e => e.PartsCost).HasPrecision(18, 2);
  modelBuilder.Entity<MaintenanceHistory>()
  .Property(e => e.LaborCost).HasPrecision(18, 2);
  modelBuilder.Entity<MaintenanceHistory>()
  .Property(e => e.TotalCost).HasPrecision(18, 2);
  ...
  .HasKey(vl => new { vl.VoucherId, vl.LeadId });
  modelBuilder.Entity<VoucherLead>()
