...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251112114746_FirstImplement")]
    partial class FirstImplement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Domains.Entities.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Domains.Entities.Input", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Domains.Entities.InputInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Domains.Entities.InputStatus", b =>
                {
            ...
            modelBuilder.Entity("Domain.Domains.Entities.Option", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Domains.Entities.OptionValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Domains.Entities.Output", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Domains.Entities.OutputInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Domains.Entities.OutputStatus", b =>
                {
                    b.Property<string>("Key")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnName("Key");
            ...
            modelBuilder.Entity("Domain.Domains.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Domains.Entities.ProductCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Domains.Entities.ProductCollectionPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Domains.Entities.ProductStatus", b =>
                {
                    b.Property<string>("Key")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnName("Key");
            ...
            modelBuilder.Entity("Domain.Domains.Entities.ProductVariant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Domains.Entities.Setting", b =>
                {
                    b.Property<string>("Key")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnName("Key");
            ...
            modelBuilder.Entity("Domain.Domains.Entities.Supplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Domains.Entities.SupplierStatus", b =>
                {
                    b.Property<string>("Key")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnName("Key");
            ...
            modelBuilder.Entity("Domain.Domains.Entities.VariantOptionValue", b =>
                {
            ...
            modelBuilder.Entity("Domain.Domains.Entities.Input", b =>
                {
                    b.HasOne("Domain.Domains.Entities.InputStatus", "InputStatus")
                        .WithMany("InputReceipts")
                        .HasForeignKey("StatusId");

                    b.HasOne("Domain.Domains.Entities.Supplier", "Supplier")
                        .WithMany("InputReceipts")
            ...
            modelBuilder.Entity("Domain.Domains.Entities.InputInfo", b =>
                {
                    b.HasOne("Domain.Domains.Entities.Input", "InputReceipt")
                        .WithMany("InputInfos")
                        .HasForeignKey("InputId");

                    b.HasOne("Domain.Domains.Entities.ProductVariant", "ProductVariant")
                        .WithMany("InputInfos")
            ...
            modelBuilder.Entity("Domain.Domains.Entities.OptionValue", b =>
                {
                    b.HasOne("Domain.Domains.Entities.Option", "Option")
            ...
            modelBuilder.Entity("Domain.Domains.Entities.Output", b =>
                {
                    b.HasOne("Domain.Domains.Entities.OutputStatus", "OutputStatus")
            ...
            modelBuilder.Entity("Domain.Domains.Entities.OutputInfo", b =>
                {
                    b.HasOne("Domain.Domains.Entities.Output", "OutputOrder")
            ...
            modelBuilder.Entity("Domain.Domains.Entities.Product", b =>
                {
                    b.HasOne("Domain.Domains.Entities.Brand", "Brand")
                        .WithMany("Products")
                        .HasForeignKey("BrandId");

                    b.HasOne("Domain.Domains.Entities.ProductCategory", "ProductCategory")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId");

                    b.HasOne("Domain.Domains.Entities.ProductStatus", "ProductStatus")
                        .WithMany("Products")
                        .HasForeignKey("StatusId");
            ...
            modelBuilder.Entity("Domain.Domains.Entities.ProductVariant", b =>
                {
                    b.HasOne("Domain.Domains.Entities.Product", "Product")
            ...
            modelBuilder.Entity("Domain.Domains.Entities.Supplier", b =>
                {
                    b.HasOne("Domain.Domains.Entities.SupplierStatus", "SupplierStatus")
                        .WithMany("Suppliers")
                        .HasForeignKey("StatusId");
            ...
            modelBuilder.Entity("Domain.Domains.Entities.VariantOptionValue", b =>
                {
                    b.HasOne("Domain.Domains.Entities.OptionValue", "OptionValue")
