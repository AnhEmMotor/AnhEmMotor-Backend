...
public class RolePermissionRepository(ApplicationDBContext context) : IRolePermissionRepository
{
    ...
    public Task<List<RolePermission>> GetByRoleIdAsync(Guid roleId, CancellationToken cancellationToken = default)
    {
    ...
    public Task<List<RolePermission>> GetByPermissionIdsAsync(
