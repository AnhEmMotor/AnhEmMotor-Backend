...
public class BookingAppointmentReadRepository(ApplicationDBContext context, ISievePaginator paginator) : IBookingAppointmentReadRepository
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return paginator.ApplyAsync<global::Domain.Entities.BookingAppointment, TResponse>(
            query,
            sieveModel,
            mode,
            cancellationToken);
    ...
    private IQueryable<global::Domain.Entities.BookingAppointment> GetQueryable(
        DataFetchMode mode = DataFetchMode.ActiveOnly)
    {
