...
namespace Infrastructure.PostgreSqlMigrations
{
    ...
    [Migration("20260603143409_AddMaxPurchaseQuantityAndLogisticsAndSupportTickets")]
    partial class AddMaxPurchaseQuantityAndLogisticsAndSupportTickets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnhEmMotor.Domain.Entities.OrderLogistics", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AnhEmMotor.Domain.Entities.ServiceBooking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AnhEmMotor.Domain.Entities.SupportTicket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Domain.Entities.CustomerContactReply", b =>
                {
                    ...
                    b.HasOne("AnhEmMotor.Domain.Entities.SupportTicket", null)
                        .WithMany("Replies")
