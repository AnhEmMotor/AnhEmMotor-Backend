...
namespace Infrastructure.PostgreSqlMigrations
{
    ...
    public partial class MajorSchemaOverhaulAndRemoveRepairAndAddVoucherAndShipment : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddColumn<string>(name: "PasswordResetToken", table: "Users", type: "text", nullable: true);
            ...
            migrationBuilder.AlterColumn<string>(
                ...
                oldType: "numeric",
                oldNullable: true);
            migrationBuilder.AddColumn<string>(name: "DescriptionJson", table: "Product", type: "text", nullable: true);
            migrationBuilder.AddColumn<string>(
                name: "MetaDescriptionJson",
                table: "Product",
                type: "text",
                nullable: true);
            migrationBuilder.AddColumn<string>(name: "MetaTitleJson", table: "Product", type: "text", nullable: true);
            migrationBuilder.AddColumn<string>(name: "NameJson", table: "Product", type: "text", nullable: true);
            migrationBuilder.AddColumn<string>(
            ...
            migrationBuilder.AddColumn<bool>(
                ...
                nullable: false,
                defaultValue: false);
            migrationBuilder.AddColumn<string>(name: "DescriptionJson", table: "Brand", type: "text", nullable: true);
            migrationBuilder.AddColumn<string>(name: "NameJson", table: "Brand", type: "text", nullable: true);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedCompletionTime = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true),
