        ...
        public static async Task SeedAsync(ApplicationDBContext context)
        {
            if (!await context.TechnologyCategories.AnyAsync())
            {
                ...
                var abs = new Technology
                {
                    ...
                    DefaultDescription = "Giúp ổn định tư thế xe bằng cách chống khóa bánh, mang lại sự an tâm cho người lái trên mọi điều kiện địa hình.",
                ...
                var esp = new Technology
                {
                    ...
                    DefaultDescription = "Động cơ thế hệ mới eSP+ 4 van giúp tăng công suất hoạt động, vận hành êm ái, tiết kiệm nhiên liệu và thân thiện môi trường.",
                ...
                var smartkey = new Technology
                {
                    ...
                    DefaultDescription = "Khóa thông minh kết hợp tính năng định vị xe và báo động chống trộm, mang lại sự tiện lợi và an tâm tuyệt đối.",
                    DefaultImageUrl = "http://localhost:5000/api/v1/MediaFile/view-image/products/placeholder-smartkey.webp"
                };
