...
#pragma warning disable CRR0035
    [Fact(DisplayName = "SO_081 - GetMyPurchases - L?y don hàng c?a chính mình")]
    ...
    [Fact(DisplayName = "SO_082 - GetPurchasesByID - L?y don hàng theo BuyerId (có quy?n)")]
    ...
    [Fact(DisplayName = "SO_083 - GetOutputs - L?y danh sách don hàng")]
    ...
    [Fact(DisplayName = "SO_084 - GetDeletedOutputs - L?y danh sách don hàng dã xóa")]
    ...
    [Fact(DisplayName = "SO_085 - GetOutputById - L?y chi ti?t don hàng")]
    ...
    [Fact(DisplayName = "SO_086 - CreateOutput - T?o don hàng (user thu?ng)")]
    ...
    [Fact(DisplayName = "SO_087 - CreateOutputForAdmin - T?o don hàng (manager)")]
    ...
    [Fact(DisplayName = "SO_088 - UpdateOutputForManager - S?a don hàng (do chính mình t?o)")]
    ...
    [Fact(DisplayName = "SO_089 - UpdateOutput - S?a don hàng (manager)")]
    ...
    [Fact(DisplayName = "SO_090 - UpdateOutputStatus - C?p nh?t tr?ng thái don hàng")]
    ...
    [Fact(DisplayName = "SO_091 - UpdateManyOutputStatus - C?p nh?t tr?ng thái nhi?u don")]
    ...
    [Fact(DisplayName = "SO_092 - DeleteOutput - Xóa don hàng")]
    ...
    [Fact(DisplayName = "SO_093 - DeleteManyOutputs - Xóa nhi?u don hàng")]
    ...
    [Fact(DisplayName = "SO_094 - RestoreOutput - Khôi ph?c don hàng")]
    ...
    [Fact(DisplayName = "SO_095 - RestoreManyOutputs - Khôi ph?c nhi?u don hàng")]
    ...
    [Fact(DisplayName = "SO_096 - Controller x? lý UnauthorizedAccessException")]
    ...
    [Fact(DisplayName = "SO_097 - Controller x? lý NotFoundException")]
    ...
    [Fact(DisplayName = "SO_098 - Controller x? lý ValidationException")]
    ...
    [Fact(DisplayName = "SO_102 - L?y danh sách tr?ng thái don hàng khi thi?u quy?n tr? 403")]
    ...
    [Fact(DisplayName = "SO_103 - Controller g?i MediatR dúng 1 l?n khi l?y danh sách tr?ng thái don hàng")]
    public async Task GetOutputStatuses_ValidRequest_CallsMediatorOnce()
    {
        var expectedStatuses = new Dictionary<string, string> { { Domain.Constants.Order.OrderStatus.Pending, "Ch? xác nh?n" } };
        _mediatorMock.Setup(m => m.Send(It.IsAny<GetOutputStatusListQuery>(), It.IsAny<CancellationToken>()))
    ...
    [Fact(DisplayName = "SO_104 - Controller tr? dúng d? li?u t? Handler khi l?y tr?ng thái don hàng")]
