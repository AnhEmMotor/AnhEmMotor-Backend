...
public class BookingAppointmentsController(ISender sender, ICurrentUserContext currentUserContext) : ApiController
{
	...
	public async Task<IActionResult> Create([FromBody] CreateBookingAppointmentCommand command, CancellationToken cancellationToken)
	{
	...
	[ProducesResponseType(typeof(ErrorResponse), StatusCodes.Status404NotFound)]
	[ProducesResponseType(typeof(ErrorResponse), StatusCodes.Status400BadRequest)]
	public async Task<IActionResult> Update(int id, [FromBody] UpdateBookingAppointmentCommand command, CancellationToken cancellationToken)
	{
	...
	[ProducesResponseType(StatusCodes.Status200OK)]
	[ProducesResponseType(typeof(ErrorResponse), StatusCodes.Status404NotFound)]
	public async Task<IActionResult> Confirm(int id, [FromBody] ConfirmBookingAppointmentRequest request, CancellationToken cancellationToken)
	{
	...
	[ProducesResponseType(typeof(ErrorResponse), StatusCodes.Status404NotFound)]
	[ProducesResponseType(typeof(ErrorResponse), StatusCodes.Status400BadRequest)]
	public async Task<IActionResult> Cancel(int id, [FromBody] CancelBookingAppointmentRequest request, CancellationToken cancellationToken)
	{
