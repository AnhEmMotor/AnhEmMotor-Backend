...
/// <summary>
/// Quản lý công nợ nhà cung cấp — theo dõi, thanh toán và chứng minh thanh toán.
/// </summary>
...
{
    /// <summary>
    /// Lấy danh sách các nhà cung cấp đang còn nợ (có phân trang, lọc — Sieve).
    /// </summary>
    ...
    /// <summary>
    /// Lấy danh sách các phiếu nhập hàng còn nợ của một nhà cung cấp.
    /// </summary>
    ...
    /// <summary>
    /// Thanh toán nợ cho nhà cung cấp (tự động cấn trừ từ phiếu cũ đến mới).
    /// </summary>
    /// <param name="supplierId">ID của nhà cung cấp.</param>
    /// <param name="request">Thông tin thanh toán (số tiền, ảnh chứng minh).</param>
    /// <param name="cancellationToken">Token hủy bỏ.</param>
    [HttpPost("suppliers/{supplierId:int}/pay")]
    [RequiresAnyPermissions(
        Permissions.Warehouse.DebtPaymentManagement.Create,
        Permissions.Accountant.DebtPaymentManagement.Create)]
    ...
    /// <summary>
    /// Lấy lịch sử thanh toán nợ của một nhà cung cấp.
    /// </summary>
    /// <param name="supplierId">ID của nhà cung cấp.</param>
    /// <param name="cancellationToken">Token hủy bỏ.</param>
    ...
    /// <summary>
    /// Tải lên ảnh chứng minh thanh toán (hóa đơn, biên lai).
    /// </summary>
    /// <param name="file">File ảnh chứng minh.</param>
    /// <param name="cancellationToken">Token hủy bỏ.</param>
    ...
    /// <summary>
    /// Xem ảnh chứng minh thanh toán (download/view by media file ID).
    /// </summary>
    /// <param name="mediaFileId">ID của file ảnh trong hệ thống.</param>
    /// <param name="cancellationToken">Token hủy bỏ.</param>
    ...
    /// <summary>
    /// Lấy danh sách các lần thanh toán nợ thiếu ảnh chứng minh (cần bổ sung).
    /// </summary>
    /// <param name="sieveModel">Thông tin phân trang, lọc, sắp xếp.</param>
    /// <param name="cancellationToken">Token hủy bỏ.</param>
    ...
    /// <summary>
    /// Lấy danh sách URL ảnh chứng minh đính kèm của một lần thanh toán nợ.
    /// </summary>
    /// <param name="id">ID của log thanh toán nợ.</param>
    /// <param name="cancellationToken">Token hủy bỏ.</param>
    ...
    /// <summary>
    /// Cập nhật danh sách URL ảnh chứng minh cho một lần thanh toán nợ.
    /// </summary>
    /// <param name="id">ID của log thanh toán nợ.</param>
    /// <param name="request">Danh sách URL ảnh mới.</param>
    /// <param name="cancellationToken">Token hủy bỏ.</param>
