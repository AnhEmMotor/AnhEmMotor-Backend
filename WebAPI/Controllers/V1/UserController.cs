...
/// <summary>
/// Qu?n lý ngu?i dùng (B?t c? ngu?i dùng nào dã dang nh?p d?u có quy?n vào dây)
/// </summary>
[ApiVersion("1.0")]
[SwaggerTag("Qu?n lý ngu?i dùng (B?t c? ngu?i dùng nào dã dang nh?p d?u có quy?n vào dây)")]
...
public class UserController(IMediator mediator, IUserStreamService userStreamService, IServiceProvider serviceProvider) : ApiController
{
    ...
    /// <summary>
    /// L?y thông tin ngu?i dùng hi?n t?i t? JWT (H? tr? SSE n?u Accept: text/event-stream)
    /// </summary>
    [HttpGet("me")]
    [Authorize]
    ...
    /// <summary>
    /// Ð?i thông tin ngu?i dùng hi?n t?i t? JWT
    /// </summary>
    [HttpPut("me")]
    [Authorize]
    ...
    /// <summary>
    /// Ð?i m?t kh?u ngu?i dùng hi?n t?i t? JWT
    /// </summary>
    ...
    /// <summary>
    /// Xoá tài kho?n c?a ngu?i dùng t? JWT
    /// </summary>
    ...
    /// <summary>
    /// Khôi ph?c tài kho?n ngu?i dùng
    /// </summary>
    ...
    /// <summary>
    /// T?i lên ?nh d?i di?n cho ngu?i dùng hi?n t?i
    /// </summary>
    [HttpPost("avatar")]
    [Authorize]
    ...
    /// <summary>
    /// L?y danh sách ánh x? gi?i tính (key ti?ng Anh - nhãn ti?ng Vi?t) d? Frontend binding.
    /// </summary>
    ...
    public IActionResult GetGenderOptions()
    {
        var options = new[]
        {
            ...
            new { key = nameof(GenderStatus.Female), label = "N?" },
