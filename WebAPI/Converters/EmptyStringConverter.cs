...
/// </summary>
/// <remarks>Use this converter to ensure that deserialized string properties are never null, but instead default
/// to an empty string. When serializing, properties with null or empty string values are not written to the JSON
/// output. This behavior can help avoid null reference issues and reduce JSON payload size for optional string
/// properties.</remarks>
public class EmptyStringConverter : JsonConverter<string>
{
    ...
    /// </summary>
    /// <param name="reader">A reference to the <see cref="Utf8JsonReader"/> positioned at the JSON value to read. The reader must be at a
    /// string token.</param>
