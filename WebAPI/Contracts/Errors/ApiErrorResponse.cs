...
/// </summary>
/// <remarks>Use this class to provide structured error information in API responses, enabling clients to handle
/// errors consistently. The class supports representing general errors, validation errors, and nested exceptions for
/// detailed diagnostics. Validation errors are included when input validation fails, and inner exceptions can be used
/// to convey exception chains for debugging purposes.</remarks>
/// <remarks>
...
public class ApiErrorResponse(string message)
{
    ...
    /// </summary>
    /// <remarks>Use this property to access additional details about the original error when handling nested
    /// or chained API exceptions. This can be useful for debugging or for providing more informative error messages to
    /// users.</remarks>
    ...
    public static ApiErrorResponse CreateProductionError(string message)
    {
    ...
    /// </summary>
    /// <remarks>This method is intended for use in development environments where exposing detailed exception
    /// information is useful for debugging. It recursively includes inner exception details, which may reveal sensitive
    /// information. Avoid using this method in production scenarios.</remarks>
    /// <param name="ex">The exception to include in the error response. Cannot be null.</param>
    /// <returns>An <see cref="ApiErrorResponse"/> populated with the exception's message, type, stack trace, and any inner
    /// exceptions.</returns>
    ...
    /// </summary>
    /// <param name="failures">A collection of validation failures to include in the error response. Each failure should specify the property
    /// name and the associated error message.</param>
...
/// </summary>
/// <remarks>Use this class to convey information about which field failed validation and the associated error
/// message. This is typically used in validation result collections to provide structured error feedback.</remarks>
