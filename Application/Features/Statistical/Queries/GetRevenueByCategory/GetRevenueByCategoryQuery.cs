...
public record GetRevenueByCategoryQuery(DateTimeOffset Start, DateTimeOffset End)
  : IRequest<Result<IEnumerable<RevenueByCategoryResponse>>>;

public class GetRevenueByCategoryQueryHandler(
    IStatisticalReadRepository repo)
  : IRequestHandler<GetRevenueByCategoryQuery, Result<IEnumerable<RevenueByCategoryResponse>>>
{
