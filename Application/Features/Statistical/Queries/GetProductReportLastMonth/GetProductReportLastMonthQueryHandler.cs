...
public class GetProductReportLastMonthQueryHandler(IStatisticalReadRepository repository) : IRequestHandler<GetProductReportLastMonthQuery, Result<IEnumerable<ProductReportResponse>>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Result<IEnumerable<ProductReportResponse>>.Success(result.OrderByDescending(x => x.SoldLastMonth));
    }
}
