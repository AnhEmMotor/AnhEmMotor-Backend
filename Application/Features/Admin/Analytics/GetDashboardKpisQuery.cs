...
namespace Application.Features.Admin.Analytics
{
    ...
    public class GetDashboardKpisHandler : IRequestHandler<GetDashboardKpisQuery, DashboardKpisResponse>
    {
        ...
        public async Task<DashboardKpisResponse> Handle(
    ...
    public class GetAnalyticsChartsHandler : IRequestHandler<GetAnalyticsChartsQuery, AnalyticsChartsResponse>
    {
        ...
        public async Task<AnalyticsChartsResponse> Handle(
            GetAnalyticsChartsQuery request,
            CancellationToken cancellationToken)
        {
            var fallback = new AnalyticsChartsResponse(
                ...
                new List<SaleLeaderboardDto>
                {
                    new("Sale A", 1000000000),
                    new("Sale B", 800000000),
                    new("Sale C", 600000000)
                });
            return await _cache.GetOrCreateAsync(
