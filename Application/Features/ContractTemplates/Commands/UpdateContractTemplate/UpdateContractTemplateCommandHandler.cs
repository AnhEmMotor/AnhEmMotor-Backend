...
public class UpdateContractTemplateCommandHandler(
    ...
    IUnitOfWork unitOfWork) : IRequestHandler<UpdateContractTemplateCommand, Result<Unit>>
{
    public async Task<Result<Unit>> Handle(UpdateContractTemplateCommand request, CancellationToken cancellationToken)
    {
