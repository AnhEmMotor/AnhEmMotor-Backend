...
public class GetContractTemplatesQueryHandler(IContractTemplateReadRepository contractTemplateReadRepository) : IRequestHandler<GetContractTemplatesQuery, Result<PagedResult<ContractTemplateResponse>>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var pageItems = query
            ...
            .Select(
                x => new ContractTemplateResponse
                {
                    Id = x.Id,
                    Name = x.Name,
                    Type = x.Type,
