...
public sealed class GetEmployeeByIdQueryHandler(IEmployeeReadRepository employeeReadRepository) : IRequestHandler<GetEmployeeByIdQuery, Result<EmployeeResponse>>
{
