...
{
    public class GetApprovedPurchaseRequestsQueryHandler(IPurchaseRequestReadRepository repository) : IRequestHandler<GetApprovedPurchaseRequestsQuery, Result<PagedResult<PurchaseRequestListResponse>>>
    {
