...
{
    public sealed class GetApprovedPurchaseOrdersForInvoiceQueryHandler(IPurchaseOrderReadRepository repository) 
        : IRequestHandler<GetApprovedPurchaseOrdersForInvoiceQuery, Result<PagedResult<PurchaseOrderListResponse>>>
    {
        public async Task<Result<PagedResult<PurchaseOrderListResponse>>> Handle(
            GetApprovedPurchaseOrdersForInvoiceQuery request,
