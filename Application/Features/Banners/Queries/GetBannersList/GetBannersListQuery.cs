...
public class GetBannersListQueryHandler(IBannerReadRepository bannerRepository) 
    : IRequestHandler<GetBannersListQuery, Result<List<BannerResponse>>>
{
    public async Task<Result<List<BannerResponse>>> Handle(GetBannersListQuery request, CancellationToken cancellationToken)
    {
