        ...
        public void Register(TypeAdapterConfig config)
        {
            config.NewConfig<MaintenanceHistory, MaintenanceTicketResponse>()
                ...
                .Map(
                    ...
                    src => src.Vehicle != null && src.Vehicle.User != null ? src.Vehicle.User.FullName : null)
                .Map(
                    dest => dest.CustomerPhone,
                    src => src.Vehicle != null && src.Vehicle.User != null ? src.Vehicle.User.PhoneNumber : null);
            config.NewConfig<MaintenanceHistory, MaintenanceTicketDetailResponse>()
                ...
                .Map(
                    ...
                    src => src.Vehicle != null && src.Vehicle.Lead != null ? src.Vehicle.Lead.Address : null)
                .Map(dest => dest.VehicleVin, src => src.Vehicle != null ? src.Vehicle.VinNumber : null)
                .Map(dest => dest.VehiclePlate, src => src.Vehicle != null ? src.Vehicle.LicensePlate : null)
                .Map(
                    dest => dest.VehicleColor,
                    src => src.Vehicle != null && src.Vehicle.ProductVariantColor != null
                        ? src.Vehicle.ProductVariantColor.ColorName
                        : null)
                .Map(
                    dest => dest.VehicleYear,
