...
namespace Application.Features.Logistics.Returns.Queries.GetReturnDetail
{
    ...
    : IRequestHandler<GetReturnDetailQuery, ReturnDetailResponse?>
    {
        public async Task<ReturnDetailResponse?> Handle(GetReturnDetailQuery request, CancellationToken cancellationToken)
        {
            ...
            return new ReturnDetailResponse
            {
                ...
                Items = [.. order.Items.Select(i => new ReturnDetailItemResponse
                {
                    Id = i.Id,
