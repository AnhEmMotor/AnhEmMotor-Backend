...
{
    public class GetActiveShipmentsQueryHandler(IParcelDeliveryOrderReadRepository parcelDeliveryOrderReadRepository) : IRequestHandler<GetActiveShipmentsQuery, List<ActiveShipmentResponse>>
    {
