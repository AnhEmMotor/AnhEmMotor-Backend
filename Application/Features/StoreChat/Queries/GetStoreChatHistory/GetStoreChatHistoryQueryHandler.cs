...
public class GetStoreChatHistoryQueryHandler(IStoreChatReadRepository storeChatReadRepository) : IRequestHandler<GetStoreChatHistoryQuery, Result<List<StoreChatMessageDto>>>
{
    public async Task<Result<List<StoreChatMessageDto>>> Handle(
        GetStoreChatHistoryQuery request,
