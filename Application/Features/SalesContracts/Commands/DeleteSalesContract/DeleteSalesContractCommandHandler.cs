...
public class DeleteSalesContractCommandHandler(ISalesContractReadRepository readRepo, IUnitOfWork unitOfWork) : IRequestHandler<DeleteSalesContractCommand, Result>
{
