...
public class UpdateSalesContractCommandHandler(ISalesContractReadRepository readRepo, IUnitOfWork unitOfWork) : IRequestHandler<UpdateSalesContractCommand, Result<SalesContractResponse>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (request.SpecialTerms != null)
            contract.SpecialTerms = request.SpecialTerms;
        if (request.WarrantyPeriod != null)
            contract.WarrantyPeriod = request.WarrantyPeriod;
        if (request.WarrantyScope != null)
            contract.WarrantyScope = request.WarrantyScope;
