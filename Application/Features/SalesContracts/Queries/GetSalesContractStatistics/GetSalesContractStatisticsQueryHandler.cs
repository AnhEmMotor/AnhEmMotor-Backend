...
public class GetSalesContractStatisticsQueryHandler(ISalesContractReadRepository readRepo) : IRequestHandler<GetSalesContractStatisticsQuery, Result<SalesContractStatisticsResponse>>
{
