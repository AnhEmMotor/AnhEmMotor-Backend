...
public sealed class UpdateProductCommandValidator : AbstractValidator<UpdateProductCommand>
{
    ...
    private void ValidateVariantOptions(List<Application.ApiContracts.Product.Requests.UpdateProductVariantRequest> variants, ValidationContext<UpdateProductCommand> context)
    {
