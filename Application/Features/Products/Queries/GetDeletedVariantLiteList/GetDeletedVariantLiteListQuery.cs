...
public sealed record GetDeletedVariantLiteListQuery : IRequest<Result<PagedResult<ProductVariantLiteResponse>>>
{
    ...
    public static GetDeletedVariantLiteListQuery FromRequest(SieveModel request)
    {
        ...
        return new GetDeletedVariantLiteListQuery
        {
            Page = request.Page ?? 1,
