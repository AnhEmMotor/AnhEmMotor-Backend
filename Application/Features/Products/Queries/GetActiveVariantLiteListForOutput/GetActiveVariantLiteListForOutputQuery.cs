...
{
    public class GetActiveVariantLiteListForOutputQuery : IRequest<PagedResult<ProductVariantLiteResponseForInput>>
    {
        ...
        public static GetActiveVariantLiteListForOutputQuery FromRequest(SieveModel request)
        {
            ...
            return new GetActiveVariantLiteListForOutputQuery
            {
                Page = request.Page ?? 1,
