...
public sealed record GetProductsListQuery : IRequest<Result<PagedResult<ProductDetailResponse>>>
{
    ...
    public static GetProductsListQuery FromRequest(SieveModel request)
    {
