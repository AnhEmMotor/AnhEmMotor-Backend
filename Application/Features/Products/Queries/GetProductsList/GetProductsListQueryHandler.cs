            ...
            e =>
            {
                ...
                bool MatchesSearch(Domain.Entities.ProductVariant variant)
                {
                    var exactVariantMatches =
                        string.Equals(variant.VariantName?.Trim(), normalizedSearch, StringComparison.OrdinalIgnoreCase) ||
                    ...
                    return productMetadataMatches ||
                        (!string.IsNullOrWhiteSpace(variant.VariantName) &&
                                variant.VariantName.Contains(normalizedSearch!, StringComparison.OrdinalIgnoreCase)) ||
                        ...
                        [.. e.ProductVariants
                                ...
                                .Select(
                                    v =>
                                    {
                                        ...
                                        var matchingColors = productMetadataMatches ||
