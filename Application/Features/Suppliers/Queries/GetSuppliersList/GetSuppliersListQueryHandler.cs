...
public class GetSuppliersListQueryHandler(ISupplierReadRepository repository) : IRequestHandler<GetSuppliersListQuery, Result<PagedResult<SupplierResponse>>>
{
