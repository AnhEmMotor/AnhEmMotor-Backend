...
public class GetDeletedSuppliersListQueryHandler(ISupplierReadRepository repository) : IRequestHandler<GetDeletedSuppliersListQuery, Result<PagedResult<SupplierResponse>>>
{
