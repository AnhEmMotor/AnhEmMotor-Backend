...
public class GetChatPlanQueryHandler(IChatReadRepository chatReadRepository, ICurrentUserContext currentUserContext) : IRequestHandler<GetChatPlanQuery, Result<ChatPlanDto>>
{
