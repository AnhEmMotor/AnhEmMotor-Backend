...
public class GetManagerChatSessionsQueryHandler(
    ...
    ICurrentUserContext currentUserContext) : IRequestHandler<GetManagerChatSessionsQuery, Result<List<ManagerChatSessionDto>>>
{
    public async Task<Result<List<ManagerChatSessionDto>>> Handle(
        GetManagerChatSessionsQuery request,
        CancellationToken cancellationToken)
    {
        ...
        var dtos = sessions
            ...
            .Select(s => new ManagerChatSessionDto { Id = s.Id, Title = s.Title })
            .ToList();
