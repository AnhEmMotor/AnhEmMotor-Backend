...
public class GetManagerChatSessionHistoryQueryHandler(
    ...
    ICurrentUserContext currentUserContext) : IRequestHandler<GetManagerChatSessionHistoryQuery, Result<List<ManagerChatMessageDto>>>
{
    public async Task<Result<List<ManagerChatMessageDto>>> Handle(
        GetManagerChatSessionHistoryQuery request,
        ...
        var dtos = messages
            ...
            .Select(
                m => new ManagerChatMessageDto
                {
                    ...
                    ReasoningSteps =
                        string.IsNullOrEmpty(m.ReasoningStepsJson)
                                ? null
