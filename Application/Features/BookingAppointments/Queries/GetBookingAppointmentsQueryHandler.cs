...
public class GetBookingAppointmentsQueryHandler(IBookingAppointmentReadRepository repo, IUserReadRepository userRepo) : IRequestHandler<GetBookingAppointmentsQuery, Result<PagedResult<BookingAppointmentResponse>>>
{
