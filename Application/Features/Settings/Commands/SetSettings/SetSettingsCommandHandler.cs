...
public sealed class SetSettingsCommandHandler(ISettingRepository settingRepository, IUnitOfWork unitOfWork) : IRequestHandler<SetSettingsCommand, (Dictionary<string, long?>? Data, ErrorResponse? Error)>
{
    public async Task<(Dictionary<string, long?>? Data, ErrorResponse? Error)> Handle(
