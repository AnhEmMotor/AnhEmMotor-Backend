...
public class GetStoreSettingsQueryHandler(ISettingRepository settingRepository) : IRequestHandler<GetStoreSettingsQuery, Result<Dictionary<string, string?>>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var publicKeys = new[] { SettingKeys.OrderValueExceeds, SettingKeys.DepositRatio, SettingKeys.DepositType, SettingKeys.FixedDepositAmount };
