...
public class CreateConversionToolCommandHandler(IConversionToolWriteRepository repository) : IRequestHandler<CreateConversionToolCommand, Result<ConversionToolResponse>>
{
