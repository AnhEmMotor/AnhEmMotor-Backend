...
public class UpdateConversionToolCommandHandler(
    IConversionToolReadRepository readRepo,
    IConversionToolWriteRepository writeRepo) : IRequestHandler<UpdateConversionToolCommand, Result<ConversionToolResponse>>
{
