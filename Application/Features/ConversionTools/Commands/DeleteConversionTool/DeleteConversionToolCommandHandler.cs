...
public class DeleteConversionToolCommandHandler(
    IConversionToolReadRepository readRepo,
    IConversionToolWriteRepository writeRepo) : IRequestHandler<DeleteConversionToolCommand, Result<bool>>
{
    public async Task<Result<bool>> Handle(DeleteConversionToolCommand request, CancellationToken cancellationToken)
    {
