...
{
    public async Task<Result<List<TechnologyResponse>>> Handle(GetAllTechnologiesQuery request, CancellationToken cancellationToken)
    {
        var query = technologyRepository.GetQueryable()
