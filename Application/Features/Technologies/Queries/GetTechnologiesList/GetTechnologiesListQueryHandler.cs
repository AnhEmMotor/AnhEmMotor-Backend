...
public class GetTechnologiesListQueryHandler(ITechnologyReadRepository repository) : IRequestHandler<GetTechnologiesListQuery, Result<List<TechnologyResponse>>>
{
