...
/// <summary>Tìm đơn hàng theo tên khách hàng hoặc SĐT (keyword) — dùng chung cho các chat tool cần tra cứu đơn hàng theo khách thay vì theo Id.</summary>
public static class ChatToolOrderSearch
{
    ...
    {
        Expression<Func<Output, bool>> filter = o =>
