...
public class GetTopSellingForChatQueryHandler(
    ...
    IServerDateProvider dateProvider) : IRequestHandler<GetTopSellingForChatQuery, Result<ChatToolEnvelope<ChatTopSellingProductDto>>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var topProducts = await statisticalReadRepository.GetTopProductsByRevenueAsync(
            start,
            end,
            limit,
            cancellationToken)
