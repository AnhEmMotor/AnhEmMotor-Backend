...
public class GetRevenueAnalysisForChatQueryHandler(
    ...
    IServerDateProvider dateProvider) : IRequestHandler<GetRevenueAnalysisForChatQuery, Result<ChatToolEnvelope<ChatRevenueAnalysisDto>>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var dto = new ChatRevenueAnalysisDto
        {
            ...
            TopProducts =
                topProducts
                .Select(
                    x => new ChatTopProductRevenueItemDto
                    {
