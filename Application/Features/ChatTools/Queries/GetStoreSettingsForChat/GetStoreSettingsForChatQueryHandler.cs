...
public class GetStoreSettingsForChatQueryHandler(ISettingRepository settingRepository, IServerDateProvider dateProvider) : IRequestHandler<GetStoreSettingsForChatQuery, Result<ChatToolEnvelope<ChatStoreSettingsDto>>>
{
