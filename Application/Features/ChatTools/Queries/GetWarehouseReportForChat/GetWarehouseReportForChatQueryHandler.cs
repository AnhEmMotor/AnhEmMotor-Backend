...
public class GetWarehouseReportForChatQueryHandler(
    ...
    IServerDateProvider dateProvider) : IRequestHandler<GetWarehouseReportForChatQuery, Result<ChatToolEnvelope<ChatWarehouseReportDto>>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var stockByBrand = tableDataList
            .Select(
                x => new ChatWarehouseBrandStockDto
                {
