...
public class GetOrderStatisticsForChatQueryHandler(
    ...
    IServerDateProvider dateProvider) : IRequestHandler<GetOrderStatisticsForChatQuery, Result<ChatToolEnvelope<ChatOrderStatisticsDto>>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var dto = new ChatOrderStatisticsDto { TotalOrders = countByStatus.Values.Sum(), CountByStatus = countByStatus };
