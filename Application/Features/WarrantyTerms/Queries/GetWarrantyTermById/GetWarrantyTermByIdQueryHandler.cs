...
public class GetWarrantyTermByIdQueryHandler(IWarrantyTermReadRepository readRepository) 
    : IRequestHandler<GetWarrantyTermByIdQuery, Result<WarrantyTermResponse>>
{
    public async Task<Result<WarrantyTermResponse>> Handle(GetWarrantyTermByIdQuery request, CancellationToken cancellationToken)
    {
