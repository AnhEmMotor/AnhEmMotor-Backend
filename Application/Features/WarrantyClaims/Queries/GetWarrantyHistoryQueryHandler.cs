...
public class GetWarrantyHistoryQueryHandler(
 IWarrantyClaimReadRepository repo) : IRequestHandler<GetWarrantyHistoryQuery, Result<IEnumerable<WarrantyHistoryResponse>>>
{
 public async Task<Result<IEnumerable<WarrantyHistoryResponse>>> Handle(GetWarrantyHistoryQuery req, CancellationToken ct)
 {
  var claims = await repo.GetHistoryByVehicleIdAsync(req.VehicleId, ct, DataFetchMode.All)
 ...
 private static WarrantyHistoryResponse Map(Domain.Entities.WarrantyClaim c)
 {
