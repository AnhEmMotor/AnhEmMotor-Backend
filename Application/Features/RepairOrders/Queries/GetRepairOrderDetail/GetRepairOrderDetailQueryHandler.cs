...
{
    public class GetRepairOrderDetailQueryHandler(IRepairOrderReadRepository repairOrderReadRepository) : IRequestHandler<GetRepairOrderDetailQuery, Result<RepairOrderResponse>>
    {
        public async Task<Result<RepairOrderResponse>> Handle(
            GetRepairOrderDetailQuery request,
