    ...
    IJobApplicationRepository jobApplicationRepository) : IRequestHandler<GetPaginatedContactsQuery, Result<PagedResult<object>>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            "support" => ApplyAssignedUserFilter(ApplyStatusFilter(support, request.Status), request.AssignedUserId)
                .Cast<object>(),
        ...
        var mappedPaged = paged.Select<object, object>(
            item =>
            {
                if (item is SupportRequest s)
                {
                                    ...
                                    Replies =
                                        s.Contact.Replies
                                                        ...
                                                        r => new ContactReplyResponse
                                                    {
                                                        ...
                                                        RepliedByName =
                                                            r.RepliedBy != null ? r.RepliedBy.FullName : null,
