...
public class GetCustomerVehicleHistoryQueryHandler(
    IVehicleReadRepository vehicleRepository) : IRequestHandler<GetCustomerVehicleHistoryQuery, Result<CustomerVehicleHistoryResponse>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return Result<CustomerVehicleHistoryResponse>.Failure(Error.NotFound("Không tìm thấy thông tin xe.", "VehicleId"));
        }

        // Mock data logic for now or real if data available in DB
        // anhemmotor-utils seeders have some data
        var response = new CustomerVehicleHistoryResponse();
        
        response.PurchaseHistory.Add(new PurchaseHistoryDto
        {
            Id = 1,
        ...
        // Add some mock warranty history
        response.WarrantyHistory.Add(new WarrantyHistoryDto
        {
            Id = 1,
