...
public class GetCustomerVehicleDetailQueryHandler(
    IVehicleReadRepository vehicleRepository) : IRequestHandler<GetCustomerVehicleDetailQuery, Result<VehicleDetailResponse>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var response = new VehicleDetailResponse
        {
            ...
            Capacity = "", // If there is capacity info
            ...
            // We can calculate WarrantyRemainingDays
    ...
    {
        if (string.IsNullOrWhiteSpace(warrantyPeriod)) return 36; // default 3 years
        // simple parsing
