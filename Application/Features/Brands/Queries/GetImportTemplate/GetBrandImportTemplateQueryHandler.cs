...
{
    public async Task<Result<FileStreamResult>> Handle(GetBrandImportTemplateQuery request, CancellationToken cancellationToken)
    {
        ...
        // Thêm một dòng dữ liệu mẫu để người dùng dễ hình dung
        int rowIndex = 5;
