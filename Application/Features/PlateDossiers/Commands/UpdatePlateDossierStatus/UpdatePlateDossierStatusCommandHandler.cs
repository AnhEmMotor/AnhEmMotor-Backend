...
namespace Application.Features.PlateDossiers.Commands.UpdatePlateDossierStatus
{
    ...
    {
        public async Task<Result<bool>> Handle(UpdatePlateDossierStatusCommand request, CancellationToken cancellationToken)
        {
            ...
            // Trigger notify khi status changed (placeholder: NotificationService hiện chỉ publish message kiểu SSE)
