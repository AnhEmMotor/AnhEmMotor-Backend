...
public class GetDeletedProductCategoriesListQueryHandler(IProductCategoryReadRepository repository) : IRequestHandler<GetDeletedProductCategoriesListQuery, Result<PagedResult<ProductCategoryResponse>>>
{
