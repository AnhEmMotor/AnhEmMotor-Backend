...
public class GetExpensesQueryHandler(IExpenseReadRepository expenseReadRepository) : IRequestHandler<GetExpensesQuery, Result<List<ExpenseResponse>>>
{
