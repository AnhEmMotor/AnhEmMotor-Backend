...
{
    public sealed class GetQuotationByIdQueryHandler(IQuotationReadRepository readRepository) : IRequestHandler<GetQuotationByIdQuery, Result<QuotationDetailResponse?>>
    {
