...
namespace Application.Common.Attributes
{
    ...
    {
        private readonly HashSet<string> _ValidKeys = ["deposit_ratio", "inventory_alert_level", "order_value_exceeds", "bike_threshold_for_meeting", "deposit_type", "fixed_deposit_amount", "Deposit_type", "Fixed_deposit_amount"];
