...
namespace AnhEmMotor.Application.Interfaces.Repositories.Vehicle
{
    public interface IVehicleReadRepository
    {
        public Task<List<global::Domain.Entities.Vehicle>> GetByUserIdAsync(string userId, CancellationToken cancellationToken);

        public Task<global::Domain.Entities.Vehicle?> GetByIdAsync(int id, CancellationToken cancellationToken);
    }
}
