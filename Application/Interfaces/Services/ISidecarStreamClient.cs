...
{
    public IAsyncEnumerable<SidecarEvent> StreamAsync(
        Guid runId,
        Guid sessionId,
        string message,
        string token,
    ...
    /// <summary>
    /// Kiểm tra registry_fingerprint hiện tại của sidecar trước khi resume (Stage 17.8).
    /// </summary>
    ...
    /// <summary>
    /// Diễn giải 1 tin nhắn chat tự do thành thao tác sửa plan (Stage 10.9).
    /// </summary>
