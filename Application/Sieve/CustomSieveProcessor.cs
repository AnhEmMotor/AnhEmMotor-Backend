...
public class CustomSieveProcessor(IOptions<SieveOptions> options) : SieveProcessor(options)
{
    protected override SievePropertyMapper MapProperties(SievePropertyMapper mapper)
    {
        ...
        mapper.Property<ReturnRequest>(p => p.OrderCode).CanSort().CanFilter();
        mapper.Property<ReturnRequest>(p => p.Status).CanSort().CanFilter();
        ...
        mapper.Property<Output>(o => o.StatusId).CanSort().CanFilter().HasName("Status");
        mapper.Property<Output>(o => o.StatusId).CanSort().CanFilter().HasName("status");
        mapper.Property<Output>(o => o.StatusId).CanSort().CanFilter().HasName("statusId");
        ...
        mapper.Property<FinanceContract>(p => p.Id).CanSort().CanFilter();
        ...
        mapper.Property<SupplierContract>(p => p.Id).CanSort().CanFilter();
        ...
        mapper.Property<SalesContract>(p => p.Id).CanSort().CanFilter();
        ...
        mapper.Property<Vehicle>(v => v.Lead!.PhoneNumber).CanSort().CanFilter().HasName("PhoneNumber");
        mapper.Property<Vehicle>(v => v.Status).CanSort().CanFilter();
