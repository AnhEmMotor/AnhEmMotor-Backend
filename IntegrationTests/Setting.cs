...
public class Setting : IClassFixture<IntegrationTestWebAppFactory>, IAsyncLifetime
{
    ...
    public async Task SETTING_001_GetAllSettings_Success()
    {
        ...
        await IntegrationTestAuthHelper.CreateUserWithPermissionsAsync(
            ...
            username,
            password,
            [Permissions.Admin.SettingManagement.View],
    ...
    public async Task SETTING_005_SetSettings_AllValidKeys_Success()
    {
        ...
        await IntegrationTestAuthHelper.CreateUserWithPermissionsAsync(
            ...
            username,
            password,
            [Permissions.Admin.SettingManagement.Edit],
            CancellationToken.None,
            email)
            .ConfigureAwait(true);
        var loginResponse = await IntegrationTestAuthHelper.AuthenticateAsync(
