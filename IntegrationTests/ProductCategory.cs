...
public class ProductCategory : IClassFixture<IntegrationTestWebAppFactory>, IAsyncLifetime
{
    ...
    [Fact(DisplayName = "PC_025 - L?y danh sách danh m?c s?n ph?m thành công (cho m?i ngu?i dùng)")]
    public async Task GetProductCategories_WithPagination_ShouldReturnCorrectData()
    {
        ...
        await IntegrationTestAuthHelper.CreateUserWithPermissionsAsync(
            ...
            username,
            password,
            [Domain.Constants.Permission.Permissions.ProductCategories.View],
    ...
    [Fact(DisplayName = "PC_026 - L?y danh sách danh m?c s?n ph?m v?i phân trang")]
    ...
    [Fact(DisplayName = "PC_027 - L?y danh sách danh m?c s?n ph?m v?i filter theo Name")]
    ...
    [Fact(DisplayName = "PC_028 - L?y danh sách danh m?c s?n ph?m v?i sorting")]
    ...
    [Fact(DisplayName = "PC_029 - L?y danh sách danh m?c không t?n t?i (Search k có k?t qu?)")]
    ...
    [Fact(DisplayName = "PC_030 - L?y danh sách danh m?c s?n ph?m cho manager thành công")]
    ...
    [Fact(DisplayName = "PC_031 - L?y danh sách danh m?c s?n ph?m dã xóa thành công")]
    ...
    [Fact(DisplayName = "PC_032 - L?y chi ti?t danh m?c s?n ph?m thành công")]
    ...
    [Fact(DisplayName = "PC_033 - L?y chi ti?t danh m?c s?n ph?m không t?n t?i")]
    ...
    [Fact(DisplayName = "PC_034 - L?y chi ti?t danh m?c s?n ph?m dã b? xóa")]
    ...
    [Fact(DisplayName = "PC_035 - T?o danh m?c s?n ph?m thành công qua API")]
    public async Task CreateProductCategory_ValidRequest_ShouldCreateCategory()
    {
        ...
        await IntegrationTestAuthHelper.CreateUserWithPermissionsAsync(
            ...
            username,
            password,
            [Domain.Constants.Permission.Permissions.ProductCategories.Create],
            CancellationToken.None,
            email)
            .ConfigureAwait(true);
        var loginResponse = await IntegrationTestAuthHelper.AuthenticateAsync(
    ...
    [Fact(DisplayName = "PC_036 - C?p nh?t danh m?c s?n ph?m thành công qua API")]
    public async Task UpdateProductCategory_ValidRequest_ShouldUpdateCategory()
    {
        ...
        await IntegrationTestAuthHelper.CreateUserWithPermissionsAsync(
            ...
            username,
            password,
            [Domain.Constants.Permission.Permissions.ProductCategories.Edit],
            CancellationToken.None,
            email)
            .ConfigureAwait(true);
        var loginResponse = await IntegrationTestAuthHelper.AuthenticateAsync(
    ...
    [Fact(DisplayName = "PC_037 - Xóa danh m?c s?n ph?m thành công qua API")]
    public async Task DeleteProductCategory_ValidId_ShouldDeleteCategory()
    {
        ...
        await IntegrationTestAuthHelper.CreateUserWithPermissionsAsync(
            ...
            username,
            password,
            [Domain.Constants.Permission.Permissions.ProductCategories.Delete],
            CancellationToken.None,
            email)
            .ConfigureAwait(true);
        var loginResponse = await IntegrationTestAuthHelper.AuthenticateAsync(
    ...
    [Fact(DisplayName = "PC_038 - Xóa nhi?u danh m?c s?n ph?m thành công")]
    ...
    [Fact(DisplayName = "PC_039 - Xóa nhi?u danh m?c s?n ph?m v?i m?t Id không h?p l?")]
    ...
    [Fact(DisplayName = "PC_040 - Xóa nhi?u danh m?c s?n ph?m v?i m?t Id dã b? xóa")]
    ...
    [Fact(DisplayName = "PC_041 - Khôi ph?c nhi?u danh m?c s?n ph?m thành công")]
    ...
    [Fact(DisplayName = "PC_042 - Khôi ph?c nhi?u danh m?c s?n ph?m v?i m?t Id chua b? xóa")]
