...
public class ProductCategory : IClassFixture<IntegrationTestWebAppFactory>, IAsyncLifetime
{
    ...
    public async Task GetProductCategories_WithPagination_ShouldReturnCorrectData()
    {
        ...
        await IntegrationTestAuthHelper.CreateUserWithPermissionsAsync(
            ...
            username,
            password,
            [Permissions.Warehouse.CategoryManagement.View],
    ...
    public async Task CreateProductCategory_ValidRequest_ShouldCreateCategory()
    {
        ...
        await IntegrationTestAuthHelper.CreateUserWithPermissionsAsync(
            ...
            username,
            password,
            [Permissions.Warehouse.CategoryManagement.Create],
            CancellationToken.None,
            email)
            .ConfigureAwait(true);
        var loginResponse = await IntegrationTestAuthHelper.AuthenticateAsync(
    ...
    public async Task UpdateProductCategory_ValidRequest_ShouldUpdateCategory()
    {
        ...
        await IntegrationTestAuthHelper.CreateUserWithPermissionsAsync(
            ...
            username,
            password,
            [Permissions.Warehouse.CategoryManagement.Edit],
            CancellationToken.None,
            email)
            .ConfigureAwait(true);
        var loginResponse = await IntegrationTestAuthHelper.AuthenticateAsync(
    ...
    public async Task DeleteProductCategory_ValidId_ShouldDeleteCategory()
    {
        ...
        await IntegrationTestAuthHelper.CreateUserWithPermissionsAsync(
            ...
            username,
            password,
            [Permissions.Warehouse.CategoryManagement.Delete],
            CancellationToken.None,
            email)
            .ConfigureAwait(true);
        var loginResponse = await IntegrationTestAuthHelper.AuthenticateAsync(
    ...
    public async Task UpdateProductCategory_ChangeParent_ShouldSucceed()
    {
        ...
        await IntegrationTestAuthHelper.CreateUserWithPermissionsAsync(
            ...
            username,
            password,
            [Permissions.Warehouse.CategoryManagement.View, Permissions.Warehouse.CategoryManagement.Edit, Permissions.Warehouse.CategoryManagement.Create],
            CancellationToken.None)
            .ConfigureAwait(true);
    ...
    public async Task UpdateProductCategory_SwitchParent_ShouldSucceed()
    {
        ...
        await IntegrationTestAuthHelper.CreateUserWithPermissionsAsync(
            ...
            username,
            password,
            [Permissions.Warehouse.CategoryManagement.View, Permissions.Warehouse.CategoryManagement.Edit],
            CancellationToken.None)
            .ConfigureAwait(true);
        var loginResponse = await _client.PostAsJsonAsync(
            "/api/v1/Auth/login",
    ...
    {
        await AuthenticateAsync([Permissions.Warehouse.CategoryManagement.Delete, Permissions.Warehouse.CategoryManagement.View]).ConfigureAwait(true);
        int parentId;
        using (var scope = _factory.Services.CreateScope())
        {
            var db = scope.ServiceProvider.GetRequiredService<ApplicationDBContext>();
    ...
    {
        await AuthenticateAsync([Permissions.Warehouse.CategoryManagement.Edit, Permissions.Warehouse.CategoryManagement.View]).ConfigureAwait(true);
        int categoryId;
        using (var scope = _factory.Services.CreateScope())
        {
            var db = scope.ServiceProvider.GetRequiredService<ApplicationDBContext>();
