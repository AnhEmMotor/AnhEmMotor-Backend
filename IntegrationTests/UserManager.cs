...
public class UserManager : IClassFixture<IntegrationTestWebAppFactory>, IAsyncLifetime
{
    ...
    public async Task UpdateUser_WithWhitespace_TrimsData()
    {
        ...
        await IntegrationTestAuthHelper.CreateUserWithPermissionsAsync(
            ...
            adminName,
            "Pass@123",
            [Permissions.Admin.UserManagement.Edit],
            CancellationToken.None)
            .ConfigureAwait(true);
        var loginResponse = await IntegrationTestAuthHelper.AuthenticateAsync(
            _client,
    ...
    public async Task ChangePassword_InvalidatesRefreshTokens()
    {
        ...
        await IntegrationTestAuthHelper.CreateUserWithPermissionsAsync(
            ...
            adminName,
            "Pass@123",
            [Permissions.Admin.UserManagement.Edit, Permissions.Admin.UserManagement.ChangePassword],
            CancellationToken.None)
            .ConfigureAwait(true);
        var loginResponse = await IntegrationTestAuthHelper.AuthenticateAsync(
            _client,
    ...
    public async Task AssignRoles_ReplacesExistingRoles()
    {
        ...
        await IntegrationTestAuthHelper.CreateUserWithPermissionsAsync(
            ...
            adminName,
            "Pass@123",
            [Permissions.Admin.UserManagement.AssignRoles],
            CancellationToken.None)
            .ConfigureAwait(true);
        var loginResponse = await IntegrationTestAuthHelper.AuthenticateAsync(
            _client,
