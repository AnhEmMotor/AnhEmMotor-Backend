...
public class InventoryReceipts : IClassFixture<IntegrationTestWebAppFactory>, IAsyncLifetime
{
    ...
    public async Task UpdateInput_WorkingStatus_UpdatesSuccessfully()
    {
        ...
        {
            Name = $"Supplier2_{uniqueId}",
            StatusId = supplierStatusId,
            Email = $"sup2_{uniqueId}@ex.com",
            Phone = "0123456789"
        };
    ...
    public async Task UpdateInputStatus_TracksConfirmedByCorrectly()
    {
        ...
        var creatorUser = await IntegrationTestAuthHelper.CreateUserWithPermissionsAsync(
            _factory.Services,
            creatorUsername,
            "Password123!",
            [],
    ...
    public async Task GetInputStatuses_WithViewPermission_ReturnsAllStatusesWithVietnameseLabels()
    {
        ...
        content!.Should().ContainKey(Domain.Constants.Input.InputStatus.Cancel).WhoseValue.Should().Be("Ðã hu?");
    }
