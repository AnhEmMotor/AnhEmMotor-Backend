...
#pragma warning disable CRR0035
    ...
    {
        var response = await _client.GetAsync("/api/v1/Statistics/daily-revenue?days=7", CancellationToken.None)
            .ConfigureAwait(true);
    ...
    {
        var response = await _client.GetAsync("/api/v1/Statistics/daily-revenue?days=30", CancellationToken.None)
            .ConfigureAwait(true);
    ...
    {
        var response = await _client.GetAsync("/api/v1/Statistics/daily-revenue?days=0", CancellationToken.None)
            .ConfigureAwait(true);
    ...
    public async Task GetMonthlyRevenueProfit_Last12Months_ReturnsCorrectData()
    {
        var response = await _client.GetAsync(
            "/api/v1/Statistics/monthly-revenue-profit?months=12",
    ...
    {
        var response = await _client.GetAsync(
            "/api/v1/Statistics/monthly-revenue-profit?months=0",
            CancellationToken.None)
            .ConfigureAwait(true);
    ...
    {
        var response = await _client.GetAsync(
            "/api/v1/Statistics/product-stock-price?variantId=1",
            CancellationToken.None)
            .ConfigureAwait(true);
    ...
    {
        var response = await _client.GetAsync(
            "/api/v1/Statistics/product-stock-price?variantId=999999",
            CancellationToken.None)
            .ConfigureAwait(true);
    ...
    {
        var response = await _client.GetAsync(
            "/api/v1/Statistics/product-stock-price?variantId=0",
            CancellationToken.None)
            .ConfigureAwait(true);
