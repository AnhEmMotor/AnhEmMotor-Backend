...
public class ChatRunExecutorTokenRefresh
{
    ...
    public void EnsureFreshToken_ConNhieuThoiGian_KhongMintLai()
    {
        ...
        tokenManagerMock.Verify(x => x.RefreshAccessToken(It.IsAny<string>(), It.IsAny<DateTimeOffset>()), Times.Never);
    }
    ...
    public void EnsureFreshToken_ConDuoiNguong_MintLaiTruocKhiGoiSidecar()
    {
        ...
        tokenManagerMock.Verify(x => x.RefreshAccessToken(token, It.IsAny<DateTimeOffset>()), Times.Once);
    }
}
