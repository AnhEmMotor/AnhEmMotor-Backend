...
public class Booking
{
    ...
    public async Task CreateBooking_LocationShowroom_SavesCorrectLocation()
    {
        ...
        _bookingInsertRepoMock.Verify(
            x => x.Add(It.Is<BookingEntity>(b => string.Compare(b.Location, BookingLocation.Showroom) == 0)),
            Times.Once);
    }
    ...
    public async Task CreateBooking_LocationCustomerAddress_SavesCorrectLocation()
    {
        ...
        {
            Location = BookingLocation.CustomerAddress,
    ...
    public async Task CreateBooking_NewLead_SetsSourceToWebStore()
    {
        ...
        _leadInsertRepoMock.Verify(
            x => x.Add(It.Is<LeadEntity>(l => string.Compare(l.Source, LeadSource.WebStore) == 0)),
            Times.Once);
    }
