...
public class ManagerChatTests
{
    ...
    public async Task GetManagerChatSessions_ReturnsSessions_WhenHasPermission()
    {
        ...
        var handler = new GetManagerChatSessionsQueryHandler(mockChatRepo.Object, mockPermissionRepo.Object, mockCurrentUserContext.Object);
    ...
    public async Task CreateManagerChatSession_ReturnsSession_WhenHasPermission()
    {
        ...
        var handler = new CreateManagerChatSessionCommandHandler(mockChatInsertRepo.Object, mockPermissionRepo.Object, mockCurrentUserContext.Object, mockConfig.Object, mockUrlProvider.Object, mockHttpClientFactory.Object, mockUnitOfWork.Object);
