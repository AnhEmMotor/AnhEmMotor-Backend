namespace Domain.Constants
{
    public static class OrderStatus
    {
        ...
        [
            Completed, ConfirmedCod, Delivering, DepositPaid, PaidProcessing,
            Pending, Refunded, Refunding, WaitingDeposit, WaitingPickup, Cancelled
        ];

        public static readonly HashSet<string> BookingPhases =
        [
            ConfirmedCod, PaidProcessing, WaitingDeposit,
            DepositPaid, Delivering, WaitingPickup
        ];
