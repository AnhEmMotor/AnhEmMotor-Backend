...
public static class SettingKeys
{
	...
	public static readonly HashSet<string> AllowedKeys = [DepositRatio, InventoryAlertLevel, OrderValueExceeds, DepositType, FixedDepositAmount,
		VehicleDepositEnabled, VehiclePartsDepositEnabled, PartsDepositEnabled, AccessoriesDepositEnabled,
		VehicleOrderValueExceeds, VehiclePartsOrderValueExceeds, PartsOrderValueExceeds, AccessoriesOrderValueExceeds,
		VehicleDepositRatio, VehiclePartsDepositRatio, PartsDepositRatio, AccessoriesDepositRatio,
		VehicleDepositType, VehiclePartsDepositType, PartsDepositType, AccessoriesDepositType,
		VehicleFixedDepositAmount, VehiclePartsFixedDepositAmount, PartsFixedDepositAmount, AccessoriesFixedDepositAmount];
