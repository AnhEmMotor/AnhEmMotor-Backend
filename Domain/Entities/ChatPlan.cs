...
public class ChatPlan : BaseEntity
{
    ...
    /// <summary>
    /// Tăng mỗi lần plan bị sửa. Dùng cho optimistic concurrency.
    /// </summary>
    ...
    /// <summary>
    /// Danh sách bước, JSON array của PlanStepDto.
    /// </summary>
    [Required]
    ...
    /// <summary>
    /// Ai chỉnh sửa lần cuối: "ai" hoặc "user".
    /// </summary>
    ...
    /// <summary>
    /// Dấu vân tay registry tool lúc plan sinh ra — revalidate lại giá trị này lúc Duyệt (Stage 17.8).
    /// </summary>
