...
public class ChatPlanTemplate : BaseEntity
{
    ...
    /// <summary>Module định tuyến — dùng để lọc template theo module, không lẫn giữa các nghiệp vụ.</summary>
    [Required]
    ...
    /// <summary>User sửa bao nhiêu lần — template chưa tốt nếu tỉ lệ cao (19.6).</summary>
    public int UserEditCount { get; set; }

    /// <summary>User huỷ bao nhiêu lần — không học từ những lần này (19.7).</summary>
    public int RejectCount { get; set; }

    public DateTimeOffset? LastUsedAt { get; set; }

    /// <summary>active | stale | disabled (19.6).</summary>
    [Required]
